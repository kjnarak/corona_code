...
function new()
	...
	local createCharacter = function()
		...
		characterObject = movieclip.newAnim({ "character1-waiting.png", "character1.png" },36, 70)
	...
	-- *********************************************************************************************
		...
		-- TOP VERTICAL SLABS
		local vSlab5 = display.newImageRect( "vertical-stone.png", 28, 58 )
		vSlab5.x = 685; vSlab5.y = 128
		vSlab5.myName = "stone"
		
		physics.addBody( vSlab5, "dynamic", { density=stoneDensity, bounce=0, friction=0.5, shape=vSlabShape } )
		levelGroup:insert( vSlab5 )
		
		local vSlab6 = display.newImageRect( "vertical-stone.png", 28, 58 )
		vSlab6.x = 760; vSlab6.y = 128
		vSlab6.myName = "stone"
		
		physics.addBody( vSlab6, "dynamic", { density=stoneDensity, bounce=0, friction=0.5, shape=vSlabShape } )
		levelGroup:insert( vSlab6 )
		
		-- TOP HORIZONTAL PLANK
		local hPlank3 = display.newImageRect( "horizontal-wood.png", 98, 14 )
		hPlank3.x = 723; hPlank3.y = 70
		hPlank3.myName = "wood"
		
		physics.addBody( hPlank3, "dynamic", { density=woodDensity, bounce=0, friction=0.5, shape=hPlankShape } ) 
		levelGroup:insert( hPlank3 )
		
		-- Rabbits
	
		local enemy1 = display.newImageRect( "monster.png", 50, 83 )
		enemy1.x = 772; enemy1.y = 235
		enemy1.myName = "enemy"
		enemy1.isHit = false
		...
		local enemy2 = display.newImageRect( "monster.png", 50, 83 )
		enemy2.x = 790; enemy2.y = 125
		enemy2.myName = "enemy"
		enemy2.isHit = false
