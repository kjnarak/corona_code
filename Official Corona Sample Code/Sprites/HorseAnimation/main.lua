...
local uma = sprite.newSpriteSheetFromData( "uma.png", require("uma_old").getSpriteSheetData() )
...
-- The following table uses the old sprite sheet data format (uma_old.lua)
-- to simplify transitioning to the new image sheet API.
--[[
local options =
{
	spriteSheetFrames = require("uma_old").getSpriteSheetData().frames,
}
--]]
