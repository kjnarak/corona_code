...
-- Multiplayer API in Corona Labs Corona SDK.  The game features an auto-hosting capability
-- and plays well in 3G as well as Wi-Fi.
--
-- Links for PubNub information and interface:
--		http://www.pubnub.com/how-it-works
--		http://www.pubnub.com/price#unlimited
--
-- Update History:
--		Version: 1.0		Inital release
--
-- Works in Corona Simulator, iOS and Android
--
...
gameroom = "mathemania"		-- channel name

-- initialize pubnub
--
-- API Calls in development mode are Free. Use Publish Key and Subscribe Key 'demo'.
-- The 'demo' keys are Shared. This means there may be channel collisions. Use channel names which are unique.
--
...
-- a note about channels (from ) 
-- API Calls in development mode are Free. 
-- Use Publish Key and Subscribe Key 'demo'. 
-- The 'demo' keys are Shared. 
--  This means there may be channel collisions. Use channel names which are unique.
...
title = display.newText ( "PubNub, Corona Labs Corona SDK\n& BeyondtheTech present", 0, 0, 400, 0, "Helvetica-Bold", 12)
