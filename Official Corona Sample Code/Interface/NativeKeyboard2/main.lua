...
local numberButtonPress = function( event )
	...
	if numberField then
		...
		-- Add the text field back again
		numberField = native.newTextField( 10, 70, 180, tHeight )
...
phoneField = native.newTextField( 10, 110, 180, tHeight )
...
urlField = native.newTextField( 10, 150, 180, tHeight )
...
emailField = native.newTextField( 10, 190, 180, tHeight )
...
passwordField = native.newTextField( 10, 230, 180, tHeight )
