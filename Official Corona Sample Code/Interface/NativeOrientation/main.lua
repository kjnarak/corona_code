...
local myLabel = display.newText( "Position (0,0) is the top left in all orientations.", 16, 90, native.systemFont, 13 )
myLabel:setTextColor( 102, 255, 102 )

-- Display current orientation using "system.orientation"
-- (default orientation is determined in build.settings file)

local orientationLabel = display.newText( "Orientation: (default)", 16, 90, native.systemFont, 15 )
orientationLabel.x, orientationLabel.y = myLabel.x, myLabel.y + myLabel.contentHeight
orientationLabel:setTextColor( 240, 240, 90, 255 )
