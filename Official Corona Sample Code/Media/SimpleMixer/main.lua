...
local textInfo = 
{
	...
	{string="CH 1", x=buttonX1-30, y=buttonY+180, font=myFont, fsize=28, r=255, g=255, b=255, handle=""},
	{string="CH 2", x=buttonX2-30, y=buttonY+180, font=myFont, fsize=28, r=255, g=255, b=255, handle=""},
	{string="CH 3", x=buttonX3-30, y=buttonY+180, font=myFont, fsize=28, r=255, g=255, b=255, handle=""},
	{string="CH 4", x=buttonX4-30, y=buttonY+180, font=myFont, fsize=28, r=255, g=255, b=255, handle=""},
	{string="Fixed", x=buttonX1-30, y=buttonY+240, font=myFont, fsize=18, r=255, g=255, b=255, handle=""},
	{string="Fixed", x=buttonX2-30, y=buttonY+240, font=myFont, fsize=18, r=255, g=255, b=255, handle=""},
	{string="Assigned", x=buttonX3-30, y=buttonY+240, font=myFont, fsize=18, r=255, g=255, b=255, handle=""},
	{string="Assigned", x=buttonX4-30, y=buttonY+240, font=myFont, fsize=18, r=255, g=255, b=255, handle=""},
	{string="Master Volume", x=buttonX2-30, y=buttonY+330, font=myFont, fsize=28, r=255, g=255, b=255, handle=""},
    {string="CH1 length "..totalTime.."  ms", x=60, y=70, font=myFont, fsize=24, r=255, g=255, b=255, handle=""},
    {string="Total  "..audio.totalChannels, x=30, y=100, font=myFont, fsize=24, r=255, g=255, b=255, handle=""},
    {string="Free  "..audio.freeChannels, x=30, y=130, font=myFont, fsize=24, r=255, g=255, b=255, handle=""},
    {string="Reserved  "..audio.reservedChannels, x=30, y=160, font=myFont, fsize=24, r=255, g=255, b=255, handle=""},
    {string="50", x=440, y=790, font=myFont, fsize=24, r=255, g=255, b=255, handle=""},
    {string="50", x= 90, y=330, font=myFont, fsize=20, r=255, g=255, b=255, handle=""},
    {string="50", x=200, y=330, font=myFont, fsize=20, r=255, g=255, b=255, handle=""},
    {string="50", x=320, y=330, font=myFont, fsize=20, r=255, g=255, b=255, handle=""},
    {string="50", x=430, y=330, font=myFont, fsize=20, r=255, g=255, b=255, handle=""},
    {string="", x=410, y=130, font=myFont, fsize=18, r=255, g=255, b=255, handle=""},
    {string="", x=410, y=150, font=myFont, fsize=18, r=255, g=255, b=255, handle=""},
    -- these last four are the channel state labels
    {string="", x=buttonX1, y=buttonY+140, font=myFont, fsize=20, r=0, g=255, b=0, handle=""},
    {string="", x=buttonX2, y=buttonY+140, font=myFont, fsize=20, r=0, g=255, b=0, handle=""},
    {string="", x=buttonX3, y=buttonY+140, font=myFont, fsize=20, r=0, g=255, b=0, handle=""},
    {string="", x=buttonX4, y=buttonY+140, font=myFont, fsize=20, r=0, g=255, b=0, handle=""}
}
...
function updateChannelLabel (index, isOn)
    ...
    if isOn then
        textInfo[textIndexOffset + index].handle:setTextColor(0,255,0)
        textInfo[textIndexOffset + index].handle.text = "ON"
    else 
        textInfo[textIndexOffset + index].handle:setTextColor(255,255,0)
...
function NarrationFinished(event)
    ...
    textInfo[23].handle:setTextColor(255,0,0)
end
...
function makeText()
    ...
    for i,item in ipairs( textInfo ) do
        ...
        item.handle:setTextColor(item.r,item.g,item.b)
    end
end
