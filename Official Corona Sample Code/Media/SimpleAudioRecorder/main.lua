...
-- title
local title = display.newText( "Echo", 0, 0, "AmericanTypewriter-Bold", 40 )
title.x, title.y = display.contentCenterX, 60
title:setTextColor( 255, 204, 102 )

local subTitle = display.newText( "Simple Audio Recorder", 0, 0, "AmericanTypewriter-Bold", 22 )
subTitle.x, subTitle.y = display.contentCenterX, title.y + subTitle.contentHeight
subTitle:setTextColor( 255, 204, 102 )
...
local recordingStatus = display.newText( " ", 0, 0, "AmericanTypewriter-Bold", 32 )
recordingStatus.x, recordingStatus.y = display.contentCenterX, 195
recordingStatus:setTextColor( 10, 240, 102 )


-- sampling rate display
local samplingRate = display.newText( " ", 0, 0, native.systemFont, 14 )
samplingRate.x, samplingRate.y = display.contentCenterX, 385
samplingRate:setTextColor( 130, 200, 255 )
